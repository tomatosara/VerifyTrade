...
export class InitialSchema1710000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE INDEX "IDX_trade_forms_status"
      ON "trade_forms" ("status") WHERE "status" IN ('pending', 'verified')
    `);
    ...
    await queryRunner.query(`
      CREATE UNIQUE INDEX "UQ_trade_confirm_unique_actor"
      ON "trade_confirmations" ("trade_uid", "actor_id")
    `);
